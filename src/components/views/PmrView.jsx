        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-slate-200">
              Le Regain PMR brings a non-surgical interventional approach to pain, sports
              injuries, orthopaedic recovery, regenerative medicine and specialized rehabilitation.
            </p>
